...
public class Product {
    ...
    public Map<String, com.example.e_commerce.model.Color> getSelectedColor() {
        return SelectedColor;
    }

    public void setSelectedColor(Map<String, com.example.e_commerce.model.Color> selectedColor) {
    ...
    public Map<String, com.example.e_commerce.model.Size> getSize() {
        return Size;
    }

    public void setSize(Map<String, com.example.e_commerce.model.Size> size) {
        Size = size;
    }
